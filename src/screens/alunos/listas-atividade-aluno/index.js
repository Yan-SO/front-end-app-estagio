...
import { todasAtividadesAluno } from "../../../services/listar/todas-atividades-aluno";
import ItemListaAtividadesAluno from "../../../components/intemListaAtividadeAluno";


export default function ListaAtividadeAlunos(){
    ...
    useEffect(() => {
        async function buscarInfo(idAluno) {
            const resp = await todasAtividadesAluno(idAluno);
    ...
    return (
        <View>
            <FlatList 
                ...
                renderItem={(item)=> <ItemListaAtividadesAluno item={item}/>}
